...
public class Robot1 extends Enemy{
	...
	public Robot1(int x, int y, int width, int height, BufferedImage sprite) {
	...
	public void destroySelf() {		
		...
		Player.currentXP+=1;
		//Player.xpSinceLevelUp = Player.currentXP - Player.lastLevelXP;
		//System.out.println(Player.xpSinceLevelUp);
		return;
	}
