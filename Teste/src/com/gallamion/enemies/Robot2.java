...
public class Robot2 extends Enemy {
	...
	public Robot2(int x, int y, int width, int height, BufferedImage sprite) {
		super(x, y, width, height, null);	
		sprites = new BufferedImage[2];
		sprites[0] = Game.robo.getSprite((32*0), (32*8), 32, 32);
		sprites[1] = Game.robo.getSprite((32*1), (32*8), 32, 32);
		
		damagedSprites = new BufferedImage[2];
		damagedSprites[0] = Game.robo.getSprite((32*2), (32*8), 32, 32);
		damagedSprites[1] = Game.robo.getSprite((32*3), (32*8), 32, 32);
