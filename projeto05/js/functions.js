$(function(){
	...
	*/
	...
	$('.barra-preco').mousemove(function(e){
		if(isDrag){
			...
			$('.pointer-barra').css('left',(mouseX-8)+'px');
	...
	/*
	sistema de slide da pag de cada carro
	*/
	...
	*/
	...
	/*
	Sistema de navegação dos depoimentos da index.html
	*/
